			...
			colors: {
				...
				news: {
					...
					category: {
						...
						national: 'hsl(var(--news-category-national))',
						other: 'hsl(var(--news-category-other))'
					},
					summary: {
						bg: 'hsl(var(--news-summary-bg))',
						border: 'hsl(var(--news-summary-border))'
					}
				}
			},
			borderRadius: {
